...
class GridBox {
public:
	// 마우스좌표를 주면 입력할수있는 그리드 좌표를 주는 static 함수
	static Pos<float> convertToGridPos(Pos<float> p) {

	}
};

// 장애물은 통과할수잇는 장애물과 그렇지 않은 장애물이 있음
class Obstacle : public Obj{
public:
};

class CanPossObstacle : public Obstacle{
public:
};

class CantPossObstacle : public Obstacle{
public:
};
